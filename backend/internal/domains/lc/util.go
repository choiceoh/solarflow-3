// lc/util.go — handler 패키지 utility 의 임시 복사본 (PR-C2 dup, PR-D 정리).
// 출처: backend/internal/handler/{tx_summary_helpers,tx_outbound,tx_outbound_dashboard}.go
// PO 의 util.go 와 거의 동일 + distinctCount + recentMonthAmounts.
