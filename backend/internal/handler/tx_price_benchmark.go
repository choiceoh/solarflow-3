...
var allowedBenchmarkRegions = map[string]bool{
	"fob_china": true, "ddp_us": true, "ddp_europe": true, "china_domestic": true, "china_export": true, "global": true,
}
  ...
  "points": [
    {
      ...
      "source_name": "표시명",
      "metric_key": "cmm_fob_china_topcon_600w|forward_q1|forward_q2|forward_q3|forward_q4|ddp_us|ddp_europe|module_centralized|module_distributed|cell|wafer|polysilicon|china_domestic|china_export|china_state_tender|cpia_cost_floor",
      "metric_label": "운영자가 보는 짧은 라벨",
      "value_date": "YYYY-MM-DD",
      "period_label": "weekly|daily|monthly|Q+1 등",
      "market_region": "fob_china|ddp_us|ddp_europe|china_domestic|china_export|global",
...
func validateBenchmarkCatalogPolicy(point model.CreatePriceBenchmarkRequest) string {
	...
	if !allowedBenchmarkRegions[point.MarketRegion] {
