  ...
  sections: [
    {
      ...
      fields: [
        ...
        {
          key: 'exchange_rate', label: '환율', formatter: 'number',
          visibleIf: { field: 'inbound_type', value: 'import' },
          inlineEditable: true, inlineEditType: 'number',
        },
    ...
    },
    {
      ...
      visibleIf: { field: 'inbound_type', value: 'import' },
      fields: [
        { key: 'etd', label: 'ETD', formatter: 'date', inlineEditable: true, inlineEditType: 'date' },
        { key: 'eta', label: 'ETA', formatter: 'date', inlineEditable: true, inlineEditType: 'date' },
        { key: 'actual_arrival', label: '실제입항', formatter: 'date', inlineEditable: true, inlineEditType: 'date' },
        { key: 'port', label: '항구', inlineEditable: true, inlineEditType: 'text' },
        { key: 'forwarder', label: '포워더', inlineEditable: true, inlineEditType: 'text' },
        { key: 'invoice_number', label: 'Invoice No.', inlineEditable: true, inlineEditType: 'text' },
        { key: 'declaration_number', label: '면장번호', inlineEditable: true, inlineEditType: 'text' },
        { key: 'incoterms', label: '인코텀즈', inlineEditable: true, inlineEditType: 'text' },
      ],
    },
    {
      title: '입고/납품',
      ...
      fields: [
        { key: 'actual_arrival', label: '입고/납품일', formatter: 'date', inlineEditable: true, inlineEditType: 'date' },
        { key: 'declaration_number', label: '면장번호', inlineEditable: true, inlineEditType: 'text' },
      ],
    },
    {
      ...
      fields: [
        { key: 'payment_terms', label: '결제조건', span: 2, inlineEditable: true, inlineEditType: 'text' },
