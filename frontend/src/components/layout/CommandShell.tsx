...
// D-112: SidebarTabsCard / SitePlaceholderPage 등이 CommandShell 경로로 import 하던
// 헬퍼는 navigation manifest 가 정본. PR-3b 후 시그니처 (enabledFeatures 추가) 가
// manifest 에 있으므로 그대로 re-export — 호출자 import 경로 호환 유지.
export { listWipMenus, listAllMenusForTenant, type SidebarMenuRegistryItem } from '@/lib/navigation/manifest';
