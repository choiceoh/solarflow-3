...
const ORDER_SERVER_SORTABLE_COLUMNS = new Set([
  "order_date",
  "order_number",
  "site_name",
  "quantity",
...
function buildColumns({
  ...
  sourceOverrides,
  riskByOrder,
}: BuildOpts): ColumnDef<Order>[] {
  const columns: ColumnDef<Order>[] = [
    {
      key: "order_date",
      label: "수주일",
      cell: (o) => formatDate(o.order_date),
      sortAccessor: (o) => o.order_date ?? "",
    },
    {
      key: "customer_name",
      label: "거래처",
    ...
    },
    {
      ...
      align: "right",
      className: "tabular-nums",
      cell: (o) => formatKw(o.capacity_kw),
      sortAccessor: (o) => o.capacity_kw ?? 0,
    },
    {
      key: "order_number",
      label: "수주번호",
    ...
    {
      key: "management_category",
      label: "구분",
      hideable: true,
      cell: (o) => MANAGEMENT_CATEGORY_LABEL[o.management_category] ?? o.management_category,
      sortAccessor: (o) =>
    ...
    },
    {
      ...
      hideable: true,
      cell: (o) => (
        <FulfillmentSourceBadge source={sourceOverrides[o.order_id] ?? o.fulfillment_source} />
      ),
      sortAccessor: (o) => sourceOverrides[o.order_id] ?? o.fulfillment_source ?? "",
    },
    {
      key: "fulfillment_risk",
      label: "충당 위험",
      hideable: true,
      cell: (o) => <OrderFulfillmentRiskBadge risk={riskByOrder[o.order_id]} />,
      sortAccessor: (o) => riskByOrder[o.order_id]?.risk ?? "",
    },
    {
      key: "unit_price_ea",
      label: "단가(장)",
      ...
      sortAccessor: (o) =>
        o.unit_price_ea ?? (o.unit_price_wp != null && o.spec_wp ? o.unit_price_wp * o.spec_wp : 0),
    },
    {
      key: "unit_price_wp",
      label: "Wp단가",
      ...
      align: "right",
      className: "tabular-nums font-mono",
      cell: (o) => (o.unit_price_wp != null ? o.unit_price_wp.toFixed(1) : "—"),
    ...
    },
    {
      ...
      label: "납기",
      hideable: true,
      cell: (o) => (o.delivery_due ? formatDate(o.delivery_due) : "—"),
      sortAccessor: (o) => o.delivery_due ?? "",
    },
    {
      key: "status",
      label: "상태",
        ...
        return (
          ...
          >
            <Button
              ...
              title={
                canReturnReservation ? "예약으로 복귀" : "출고된 수주는 예약으로 복귀할 수 없습니다"
              }
...
export const ORDER_COLUMN_META: ColumnVisibilityMeta[] = buildColumns({
  sourceOverrides: EMPTY_OVERRIDES,
  riskByOrder: {},
}).map(({ key, label, hideable, hiddenByDefault }) => ({ key, label, hideable, hiddenByDefault }))
...
function OrderListTable({
  ...
  const resolvedServerMode = serverMode
    ? { ...serverMode, sortableColumnIds: ORDER_SERVER_SORTABLE_COLUMNS }
    : undefined
  ...
  return (
    <MetaTable
      ...
      rowClassName={(o) =>
        cn(
          "hover:bg-accent/50",
          o.status === "cancelled" && "bg-gray-50 text-muted-foreground line-through",
        )
      }
