...
export default function ProcurementPage() {
  ...
  // 활성 탭만 fetch (lazy).
  const { items: pagedPos, total: poTotal, loading: poLoading, reload: reloadPO } = usePOListPaged({
  ...
  const { items: pagedLcs, total: lcTotal, loading: lcLoading, reload: reloadLC } = useLCListPaged({
