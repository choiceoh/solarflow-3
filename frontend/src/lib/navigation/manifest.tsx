...
const WarehouseLocationsPage = lazy(() => import('@/pages/wms/WarehouseLocationsPage'));
const PickingWorkPage = lazy(() => import('@/pages/wms/PickingWorkPage'));
const ReceivingLogPage = lazy(() => import('@/pages/wms/ReceivingLogPage'));
