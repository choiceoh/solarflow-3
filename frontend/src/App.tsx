            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute />}>
                <Route element={<AppLayout />}>
                  ...
                  />
                  <Route
                    path="/data/manufacturers/:id/edit"
                    element={
                      <RoleGuard allowedRoles={["admin", "operator"]}>
                  ...
                  />
                  <Route
                    path="/masters/construction-sites-v2"
                    element={
                      <RoleGuard allowedRoles={["admin", "operator"]}>
                        <ConstructionSitesV2Page />
                      </RoleGuard>
                    }
                  />
                  ...
                  <Route
                    path="/outbound-detail-meta-demo"
                    element={<OutboundDetailMetaDemoPage />}
                  />
                  <Route
                    path="/declaration-detail-meta-demo"
                    element={<DeclarationDetailMetaDemoPage />}
                  />
                  ...
                  <Route
                    path="/baro/price-book"
                    element={
                      <RoleGuard allowedRoles={["admin", "operator"]}>
                        <PartnerPriceBookPage />
                      </RoleGuard>
                    }
                  />
                  <Route
                    path="/baro/group-purchase"
                    element={
                      <RoleGuard allowedRoles={["admin", "operator"]}>
                        <GroupPurchaseRequestPage />
                      </RoleGuard>
                    }
                  />
                  <Route
                    path="/group-trade/baro-inbox"
                    element={
                      <RoleGuard allowedRoles={["admin", "operator"]}>
                        <BaroRequestInboxPage />
                      </RoleGuard>
                    }
                  />
