...
export interface ExpenseSummaryMonthPoint {
  month: string
  count?: number
  amount?: number
}
...
export interface ExpenseSummary {
  ...
  by_type_amount: Partial<Record<ExpenseType | string, number>>
  monthly_amount?: ExpenseSummaryMonthPoint[]
  monthly_linked_count?: ExpenseSummaryMonthPoint[]
}
