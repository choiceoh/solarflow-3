...
export interface SummaryMonthPoint {
  month: string
  count?: number
  amount?: number
}
...
export interface POSummary {
  ...
  total_mw: number
  by_status: Partial<Record<POStatus | string, number>>
  by_contract_type: Partial<Record<ContractType | string, number>>
  monthly_count?: SummaryMonthPoint[]
}
...
export interface LCSummary {
  ...
  amount_usd: number
  bank_count: number
  by_status: Partial<Record<LCStatus | string, number>>
  monthly_amount?: SummaryMonthPoint[]
}
...
export interface TTSummary {
  ...
  po_count: number
  by_status: Partial<Record<TTStatus | string, number>>
  monthly_amount?: SummaryMonthPoint[]
}
...
export const LC_STATUS_LABEL: Record<LCStatus, string> = {
  pending: "대기",
  opened: "개설",
  docs_received: "서류접수",
  settled: "결제완료",
