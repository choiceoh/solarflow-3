...
- **[D-145](DECISIONS.md#d-145)** — 테넌트 모듈화 5 PR 시리즈. BARO 측 sidebar 12개 항목 (영업홈·CRM·견적·배차·미수·RFM 등) 이 `packs/baro-domain` 으로 묶여 admin UI 매트릭스에서 일괄 토글 가능. 가시성 정본은 `enabled_features` (서버 → /me → frontend 한 방향).
